      ...
      <div className="container mx-auto px-6 md:px-10 max-w-[1440px]">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mt-2 mb-4">
            Boards, Standards &amp; National Initiatives
          </h2>
          <div className="w-12 h-1 bg-primary mb-5" />
          <p className="text-muted-foreground font-sans max-w-2xl text-lg leading-relaxed">
            Shaping the interoperability frameworks, digital health policies, and governance structures that power modern healthcare systems across two continents.
          </p>
        </motion.div>
